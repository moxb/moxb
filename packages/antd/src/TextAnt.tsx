...
export const TextAnt = observer(
    class TextAnt extends React.Component<BindStringAntProps> {
 ...
 */
export const TextSearchAnt = observer(
    class TextSearchAnt extends React.Component<BindSearchStringAntProps> {
        _clearBtnOffset: string;

        constructor(props: BindSearchStringAntProps) {
            super(props);
            this._clearBtnOffset = '85px';
        }
        ...
        getSearchBtnWidth() {
            ...
            this._clearBtnOffset = requiredElement ? requiredElement.offsetWidth + 10 + 'px' : '85px';
        }
...
export const TextFormAnt = observer(
    class TextFormAnt extends React.Component<BindStringAntProps & BindFormItemAntProps> {
        render() {
