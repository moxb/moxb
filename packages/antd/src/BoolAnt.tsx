...
export const BoolAnt = observer(
    class BoolAnt extends React.Component<BindAntProps<Bool> & CheckboxProps> {
        render() {
...
export const BoolSwitchAnt = observer(
    class BoolSwitchAnt extends React.Component<BindAntProps<Bool> & AllowedSwitchProps> {
        render() {
...
export const BoolFormAnt = observer(
    class BoolFormAnt extends React.Component<BindAntProps<Bool> & Partial<FormItemProps> & CheckboxProps> {
        render() {
...
export const BoolSwitchFormAnt = observer(class BoolSwitchFormAnt extends React.Component<
