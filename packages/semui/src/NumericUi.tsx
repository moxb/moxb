...
export const NumericUi = observer((props: FormInputProps & BindNumericUiProps) => {
    const { operation, id, label, invisible, hideErrors, width, size, ...rest } = parseProps(props);
    if (invisible) {
        return null;
    }
    return (
        ...
        >
            ...
            <Input
                id={id + '_in'}
                type={operation.inputType || props.type || 'number'}
