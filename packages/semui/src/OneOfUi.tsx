...
export const OneOfUi = observer(
    class OneOfUi extends React.Component<BindUiProps<OneOf> & FormRadioProps> {
        render() {
...
export const OneOfSelectUi = observer(
    class OneOfSelectUi extends React.Component<BindUiProps<OneOf> & FormFieldProps> {
        render() {
