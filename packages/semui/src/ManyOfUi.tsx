...
export const ManyOfUi = observer((props: BindUiProps<ManyOf> & FormFieldProps) => {
    const { operation, id, invisible, type, width, hideErrors, label, error, ...rest } = parseProps(props);
