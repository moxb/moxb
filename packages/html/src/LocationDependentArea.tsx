...
export const LocationDependentArea = inject(
    'locationManager',
    'tokenManager'
)(
    observer(
        class LocationDependentArea<DataType> extends React.Component<LocationDependentAreaProps<DataType>> {
            ...
            _getStates(props: LocationDependentAreaProps<DataType>) {
                const {
                    id,
                    part,
                    mountAll,
