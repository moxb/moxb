...
describe('State-Space Handler implementation', () => {
    ...
    it('When given no tokens, should return the root state', () => {
        expect(handler.findSubState([], 0)!.label).toBe('Root state');
    });
