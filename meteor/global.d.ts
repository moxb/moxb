// From: https://github.com/VeliovGroup/Meteor-Files/blob/dev/docs/typescript-definitions.md
...
declare module 'meteor/ostrio:files' {
    ...
    class FileObj<MetadataType> {
        ...
        mime: string;
        'mime-type': string;
        _fileRef: any; // TODO: had to add this manually
    }
    ...
    interface FilesCollectionConfig<MetadataType> {
        ...
        disableDownload?: boolean; // TODO: added manually
    ...
    interface LoadOptions<MetadataType> {
        fileName: string;
        meta?: MetadataType;
        headers: any; // TODO: added manually
        type?: string;
        size?: number;
        userId?: string;
        fileId?: string;
...
declare module 'meteor/moxb:file-mirror-service' {
    import type { MeteorMethodControl } from '@moxb/meteor';

    interface MirroredFileCore {
        originalUrl: string;
    }
     ...
     */
    interface MirroredFileServerInfo extends MirroredFileInfo {
        path: string;
    }
     ...
     */
    interface MirrorService<ExtraMeta = {}> {
        /**
    ...
    function getMirrorService(): MirrorService;
    ...
    function createMirrorService<Meta = {}>(props: MirrorServiceProps): MirrorService;
